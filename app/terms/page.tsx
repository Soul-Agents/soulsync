    ...
    <div className="container mx-auto px-4 py-24">
      ...
      <div className="prose prose-invert max-w-none">
        ...
        <section className="mb-8">
          ...
          <p>
            By accessing and using Soul AI Agents services, you agree to be bound by these Terms of Service 
        ...
        <section className="mb-8">
          ...
          <p>
            Permission is granted to temporarily access Soul AI Agents services for personal or business use, 
