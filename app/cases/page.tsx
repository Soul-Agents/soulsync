    ...
    <main className="min-h-screen bg-gradient-to-b from-black via-electric-purple/5 to-black pt-24 overflow-hidden">
      ...
      <div className="container mx-auto px-4 pb-20 relative max-w-5xl">
        <div className="text-center mb-20">
          ...
          <div className="text-4xl sm:text-6xl font-bold mb-6 gradient-text animate-fade-in tracking-tight">
            <motion.span
          ...
          <div className="text-lg sm:text-xl text-white/60 max-w-2xl mx-auto animate-fade-in-delay font-light">
            <motion.span
              initial={{ y: 20, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
              transition={{ duration: 0.7, ease: "easeOut", delay: 0.2 }}
            >
              See how Soul Agents is revolutionizing community engagement for leading Web3 projects
            </motion.span>
          </div>
