    ...
    <main className="min-h-screen bg-gradient-to-b from-black via-electric-purple/5 to-black pt-24 pb-16 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="text-center mb-12">
          ...
          <div className="text-4xl sm:text-6xl font-bold mb-6 gradient-text">
            <motion.span
          ...
          <div className="text-lg sm:text-xl text-white/80 max-w-2xl mx-auto mb-10 leading-relaxed">
            <motion.span
              initial={{ y: 20, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
            >
              The first autonomous AI agent on X (Twitter) in the crypto space. Crypto Bunny demonstrates 
              how AI agents can engage with communities, provide insights, and maintain an authentic personality
              <span className="inline-block ml-1">
                <motion.span variants={bouncyAnimation} initial="initial" animate="animate">✨</motion.span>
              </span>
            </motion.span>
          </div>
