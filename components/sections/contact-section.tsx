...
export default function ContactSection() {
  return (
    <section id="contact" className="py-20 bg-dark-navy/30 relative overflow-hidden">
          ...
          <div className="text-center space-y-8">
            ...
            <div className="flex flex-col items-center space-y-4">
              ...
              >
                ...
                <span className="text-white/80 group-hover:text-white transition-colors">@soul_agents</span>
              </a>
              <a
              ...
              >
                <Twitter className="w-5 h-5 text-electric-purple flex-shrink-0 group-hover:scale-110 transition-transform duration-300" />
                <span className="text-white/80 group-hover:text-white transition-colors">@adag1oeth</span>
              </a>
              <a
            ...
            <div className="pt-8">
              <p className="text-white/90 text-xl mb-6 font-medium animate-fade-in-delay">
                ...
                <span className="text-lg text-white/70">
                  Be among the first to deploy AI Agents for your project's X and Telegram channels!
                </span>
              </p>
              <a
